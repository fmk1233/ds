...
<head>
    ...
    <link rel="stylesheet" href="../static/table.min.css">
    <link rel="stylesheet" href="../static/container.min.css">
        ...
        <table class="ui green celled striped table">
            ...
            <tbody>
                ...
                foreach ($allApiS as $key => $item) {
                    ...
                    $NO = $num++;
                    echo "<tr><td>{$NO}</td><td><a href=\"$link\" target='web'>{$item['service']}</a></td><td>{$item['title']}</td><td>{$item['desc']}</td></tr>";
                }
                ?>
            </tbody>
        </table>
