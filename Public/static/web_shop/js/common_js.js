...
//文本框登录注册事件
    $('#user_text, #tbPassword, #confirm_pwd_text, #Codes_text,#register input').blur(function () {
        var $el = $(this);
    ...
    $('.Reg_log_style .frame_style i').on('click', function () {
        $(this).prev().trigger('focus');
    });
    $("#user_text, #tbPassword, #confirm_pwd_text, #Codes_text,#register input").focus(function () {
        var $el = $(this);
        var $parent = $el.parent();
