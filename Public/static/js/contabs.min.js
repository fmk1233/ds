$(function () {
    ...
    function c() {
        var o = $(this).data('service'), m = $(this).data("index"), l = $.trim($(this).text()), k = true;
        ...
        if (k) {
            ...
            var href = ds.url($(this).data());
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + href + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
