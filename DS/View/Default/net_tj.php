                ...
                <div class="col-xs-12 zs-md-10">
                    ...
                    <div class="page-content-border">
                        <div class="page-content-title">
                            <h1><?php echo T('安置'),T('网络图'); ?><small></small></h1>
...
<script type="text/javascript">
    $(function () {
        ...
        var net_type = 'net';
        var data = {service:'Net.Net',type:2,qtype:'id',qvalue:member_id,net_type:net_type};
        loadNet();
        var tree_data =  {service: 'Net.Net', type: 2, qtype: '', qvalue: 0, net_type: 'tree'};
