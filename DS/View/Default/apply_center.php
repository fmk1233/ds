                                ...
                                <div class="col-xs-12 profile-info summary-info">
                                    <div class="portlet light">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <span class="ui-text-blue"><?php echo T('报单中心申请'); ?></span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button class="btn blue mt-clipboard" type="submit" id="submit"><i class="fa fa-check"></i> <?php echo T('确认'); ?></button>
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject ui-text-blue bold uppercase"><?php echo T('报单中心申请'),T('记录')?></span>
                                        </div>
                                        <div class="actions">
