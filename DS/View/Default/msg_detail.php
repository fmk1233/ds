                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject ui-text-blue bold uppercase"><?php echo T('留言详情'); ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="ibox">
                                            <div class="ibox-content">
                                                <div class="text-center article-title">
                                                    <span class="text-muted"><i class="fa fa-clock-o"></i> <?php echo date('Y-m-d H:i:s',$msg['add_time']); ?></span>
                                                    <h3><?php echo $msg['msg_title']; ?></h3>
                                                </div>
                                                <div><?php echo T('留言'); ?>：</div>
                                                <?php echo html_entity_decode($msg['content']); ?>
                                                <hr>
                                                <div><?php echo T('回复'); ?>：</div>
