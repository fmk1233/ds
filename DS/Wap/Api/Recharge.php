...
class Api_Recharge extends Api_Common
{
    ...
    public function getRules()
    {
        return array(
            'doRecharge' => array(
                ...
                'moneyType' => array('name' => 'money_type', 'type' => 'int', 'require' => true, 'min' => 0, 'desc' => '充值类型'),
    ...
    public function recharge()
    {
        ...
        $result['bonus_names'] = $bonus_name;
        $result['params'] = Common_Function::rechargeParams();
        return $result;
    }
    ...
    public function getRechargeList()
    {
        ...
        foreach ($result['rows'] as &$row) {
            $row['money_type'] = Common_Function::getBonusName($row['money_type']);
