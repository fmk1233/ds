<div class="mui-navbar-inner mui-bar mui-bar-nav">
    ...
    <h1 class="mui-center mui-title">申请报单中心记录</h1>
</div>
<div class="mui-page-content">
    <div class="ui-foot-content">
        <a href="#apply_m" class="mui-btn mui-btn-primary ui-btn-block" v-if="can_apply">申请报单中心</a>
    </div>
        ...
        <div class="mui-scroll">
            <div class="ui-box-row">
                ...
                <ul class="ui-hd-row mui-row ui-list-title">
                    <li class="mui-col-sm-5 mui-col-xs-5">申请会员</li>
                ...
                <ul class="mui-table-view ">
                    ...
                    <li class="mui-table-view-cell ui-main-row" v-for="upgrade in upgrade_list">
                        <ul class="ui-bd-row mui-row">
                            <li class="mui-col-sm-5 mui-col-xs-5"><span>{{upgrade.user_name}}</span>
                            ...
                            <li class="mui-col-sm-4 mui-col-xs-4"><span class="ui-text-success">{{upgrade.old_rank}}<i
                                    class="icon icon-jiantou"></i></span><br><span class="ui-text-danger">{{upgrade.new_rank}}</span></li>
