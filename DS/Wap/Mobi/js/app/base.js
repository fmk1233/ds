...
layui.define(['jquery'], function (exports) { //提示：组件也可以依赖其它组件，如：layui.define('layer', callback);
    ...
    var ds = {
        sendAjax: function ($param, security) {
            ...
            if (security) {
                ...
                var $ajax = $.extend({}, {
                    ...
                    headers: {Sign: data.sign, Token: data.token, Usertoken: $user_token}
                }, $params);
        ...
        sendFormAjax: function ($form, $callback, $file) {
            ...
            if ($file) {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    headers: {Sign: params.sign, Token: params.token,Usertoken: $user_token},
                    complete: function () {
                        delete  services[key];
                    },
        ...
        pageUrl: baseUrl + '../DS/Wap/Mobi/page/',
        myTime: {
            CurTime: function () {
