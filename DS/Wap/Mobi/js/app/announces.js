...
layui.define(['jquery', 'base'], function (exports) { //提示：组件也可以依赖其它组件，如：layui.define('layer', callback);
    ...
    var data = {news_list: [], loading: 0}, vue, page = {total: 1, limit: 10, offset: 0};
    var obj = {
        getData: function () {
    ...
    vue = new Vue({
        ...
        mounted:function () {
            mui('#announces .mui-scroll-wrapper').scroll({
                bounce: true, //是否启用回弹
    ...
    $('body').on('viewDidLoad', '#announces', function (e) {
