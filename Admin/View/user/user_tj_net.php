                ...
                <div class="ibox-title">
                    ...
                    <div class="pull-right">
                        <div class="btn-group" id="type">
                            <button type="button" class="btn btn-xs btn-white active" data-type="net">网络图</button>
                            <button type="button" class="btn btn-xs btn-white" data-type="tree">树状图</button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var net_type = 'net';
        var data = {service:'DUser.Net',type:2,qtype:'id',qvalue:member_id,net_type:net_type};
        loadNet();
        var tree_data =  {service: 'DUser.Net', type: 2, qtype: '', qvalue: 0, net_type: 'tree'};
